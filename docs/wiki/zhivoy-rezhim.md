...
Спикер говорит, Java-сервис распознаёт речь, модель делит её на законченные мысли, агент делает из каждой мысли слайд в выбранной дизайн-системе. Конец мысли модель видит по первому предложению следующей темы или по молчанию дольше 4 секунд. Пауза посреди мысли её не обрывает. На Qwen3.8 27B слайд появляется через 4–6 секунд после конца мысли.
...
5. Говорите законченными мыслями. Когда мысль закончена, её слайд появляется справа в колонке **Следующий слайд из речи**, а когда готов, сам уходит в зал и встаёт слева в **На экране зала**.
...
|---|---|---|
| показать залу слайд из правой колонки сразу | **Показать залу** | Пробел |
