...
GRAY_SAT = 0.25
"""Насыщенность, ниже которой заливка считается серой: сизый круг 5A6775 на тёмном шаблоне тоже серый."""

GRAY_LUMA = (0.3, 0.9)
"""Яркость серой заглушки: светлее фона, темнее белого. На тёмном шаблоне заглушка темнее."""
